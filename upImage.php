...
//For Database Insertion
 ...
 if(!isset($errMSG))
 {
 $que = "INSERT INTO center(profile) VALUES('" . $coverpic . "') WHERE username= '$_SESSION[username]' ";
 ...
 //Fetch Qquery
 $que = "SELECT * FROM center where username='$_SESSION[username]'";
...
<!--Display Image-->
<div>
 <label>Image : </label><br><img src="image/<?php echo $row['profile']; ?> " alt="image">
</div>
</body>
</html>
