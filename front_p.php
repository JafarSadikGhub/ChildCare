        ...
        <div class="search-container">
           ...
           <div class="container" style="width:800px;">
                ...
                <ul class="nav nav-tabs">
                     ...
                     <li><a data-toggle="tab" href="#cart">Cart <span class="badge"><?php if(isset($_SESSION["childcare"])) { echo count($_SESSION["childcare"]); } else { echo '0';}?></span></a></li>
                </ul>
                <div class="tab-content">
                     ...
                     <div class="col-md-4" style="margin-top:12px;">
                          <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px; height:400px;" align="center">
                               ...
                               <h4 class="text-info"><?php echo $row["cenname"]; ?></h4>
